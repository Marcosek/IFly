...
<head>
    ...
    <title>IFly - Moje zamówienia</title>
...
<body>
  ...
  <div class="main-content">
    <div class="container-panels">
      ...
      <div class="panel2">
            <h2>Twoje aktywne zamówienia</h2>
        <?php
...
$conn = new mysqli($servername, $username, $password, $dbname);
      $query = "SELECT * FROM orders WHERE username = '" . $_SESSION['zalogowany'] . "'";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<li>Nr. zamówienia: " . $row["order_id"] . " Data zamówienia: " . $row["order_date"] ." Cena: ". $row["total_price"] . " Adres: ". $row["shipping_address"] . " Status: " . $row["status"] . "</li>";
    }

    echo "</ul>";
} else {
    echo "Brak zamówień</p>";
}
